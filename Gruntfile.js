...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new fronius name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/fronius.png')) {
            fs.renameSync(__dirname + '/admin/fronius.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/fronius.html')) {
            fs.renameSync(__dirname + '/widgets/fronius.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/fronius/js/fronius.js')) {
            fs.renameSync(__dirname + '/widgets/fronius/js/fronius.js', __dirname + '/widgets/fronius/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/fronius')) {
            fs.renameSync(__dirname + '/widgets/fronius',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /fronius/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'fronius'
                        },
                        {
                            match: /@@Author@@/g,
                            replacement: author
