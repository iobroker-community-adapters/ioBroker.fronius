function createInverterObjects(adapter, id, obj) {
    ...
    addObjectNotExists(adapter,"Inverters." + id,"PDC","DC power tracker 1","number","W",obj,"","value");
    ...
    addObjectNotExists(adapter,"Inverters." + id,"PDC_2","DC power tracker 2","number","W",obj,"","value");
...
function createPowerFlowObjects(adapter, obj) {
    ...
    addObjectNotExists(adapter,"Site","P_Grid","Actual grid power","number","W",obj,"","value");
    addObjectNotExists(adapter,"Site","P_Load","Actual load power","number","W",obj,"","value");
    addObjectNotExists(adapter,"Site","P_Akku","Actual akku power","number","W",obj,"","value");
    addObjectNotExists(adapter,"Site","P_PV","Actual PV power","number","W",obj,"","value");

    addObjectNotExists(adapter,"Site","E_Day","Produced energy current day","number","Wh",obj,"","value");
    addObjectNotExists(adapter,"Site","E_Year","Produced energy current year","number","Wh",obj,"","value");
    addObjectNotExists(adapter,"Site","E_Total","Produced energy total","number","Wh",obj,"","value");

    addObjectNotExists(adapter,"Site","rel_Autonomy","Relative PV autonomy","number","%",obj,"","value");
    addObjectNotExists(adapter,"Site","rel_SelfConsumption","Relative PV self consumption","number","%",obj,"","value");
...
function addObjectNotExists(adapter,path,stateId,stateName = '',stateType='', stateUnit='',apiObject=Object(null),stateDescription='',stateRole=''){
    ...
    if(apiObject === null || apiObject== 'undefined'){
        ...
        if(apiObject[stateId] != null && typeof(apiObject[stateId]) == 'object'){
