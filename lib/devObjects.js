function createInverterObjects(adapter, id, obj) {
    ...
    addObjectNotExists(adapter,"inverter." + id,"DeviceStatus.InverterState","Inverter state");
    addObjectNotExists(adapter,"inverter." + id,"DeviceStatus.InverterErrorState","Inverter Error state");
