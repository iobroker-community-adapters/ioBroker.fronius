function createInverterObjects(adapter, id, obj) {
    ...
    if (obj.hasOwnProperty("IDC")) {
        adapter.setObjectNotExists('inverter.' + id + '.IDC', {
            type: "state",
            common: {
                name: "DC current tracker 1",
                type: "number",
                role: "value",
                unit: "A",
                read: true,
                write: false,
                desc: "DC current tracker 1"
            },
            native: {}
        });
    }
    ...
    if (obj.hasOwnProperty("UDC")) {
        ...
        adapter.setObjectNotExists('inverter.' + id + '.PDC', {
            type: "state",
            common: {
                name: "DC power tracker 1",
                type: "number",
                role: "value",
                unit: "W",
                read: true,
                write: false,
                desc: "DC power tracker 1"
            },
            native: {}
        });
    }
    if (obj.hasOwnProperty("UDC_2")) {
        ...
        adapter.setObjectNotExists('inverter.' + id + '.PDC_2', {
            type: "state",
            common: {
                name: "DC power tracker 2",
                type: "number",
                role: "value",
                unit: "W",
                read: true,
                write: false,
                desc: "DC power tracker 2"
            },
            native: {}
        });
    }
    if (obj.hasOwnProperty("T_AMBIENT")) {
        adapter.setObjectNotExists('inverter.' + id + '.T_AMBIENT', {
            type: "state",
            common: {
                name: "Inverter case temperature",
                type: "number",
                role: "value",
                unit: "°C",
                read: true,
...
function createArchiveObjects(adapter, id, obj) {
    ...
    if (obj.hasOwnProperty("Current_DC_String_2")) {
        adapter.setObjectNotExists('inverter.' + id + '.Current_DC_String_2', {
            type: "state",
            common: {
                name: "Current_DC_String_2",
                type: "number",
                role: "value",
                unit: "A",
                read: true,
                write: false,
                desc: "Current_DC_String_2"
            },
            native: {}
        });
    }
...
function createStorageObjects(adapter, id, obj) {
    ...
    if (obj.hasOwnProperty("StateOfCharge_Relative")) {
    ...
    if (obj.hasOwnProperty("Voltage_DC")) {
    ...
    if (obj.hasOwnProperty("Current_DC")) {
    ...
    if (obj.hasOwnProperty("Temperature_Cell")) {
    ...
    if (obj.hasOwnProperty("Voltage_DC_Maximum_Cell")) {
    ...
    if (obj.hasOwnProperty("Voltage_DC_Minimum_Cell")) {
    ...
    if (obj.hasOwnProperty("DesignedCapacity")) {
    ...
    if (obj.hasOwnProperty("Capacity_Maximum")) {
        adapter.setObjectNotExists('storage.' + id + '.controller.Capacity_Maximum', {
            type: "state",
            common: {
    ...
    if (obj.hasOwnProperty("Details")) {
        adapter.setObjectNotExists('storage.' + id + '.controller.Details', {
            type: 'channel',
            common: {
                name: "details",
                role: "info"
        ...
        if(obj.Details.hasOwnProperty("Manufacturer")){
            adapter.setObjectNotExists('storage.' + id + '.controller.Details.Manufacturer', {
                type: "state",
                common: {
                    name: "Manufacturer",
                    type: "string",
        ...
        if(obj.Details.hasOwnProperty("Model")){
            adapter.setObjectNotExists('storage.' + id + '.controller.Details.Model', {
                type: "state",
                common: {
                    name: "Model",
                    type: "string",
        ...
        if(obj.Details.hasOwnProperty("Serial")){
            adapter.setObjectNotExists('storage.' + id + '.controller.Details.Serial', {
                type: "state",
                common: {
                    name: "Serial",
                    type: "string",
    ...
    // wait a bit for creating the previous objects before creating the fallback once
    setTimeout(function() {
        adapter.log.debug("Fallback MissingStorageObjects started!")
        // fallback for not predefined parameters -> defined as number without unit
        for (var para in obj) {
            adapter.setObjectNotExists('storage.' + id + '.controller.' + para.toString(), {
                type: "state",
                common: {
                    name: para.toString(),
                    type: "mixed",
                    ...
                    read: true,
                    write: false,
                    desc: para.toString() + '_Fallback'
                },
                native: {}
            });
        }
        adapter.log.debug("Fallback MissingStorageObjects finished!")
    }, 2000);
...
function createInfoObjects(adapter, obj) {
    ...
    addObjectNotExists(adapter,"info","connection","Fronius connected","boolean","",null,"Is Fronius inverter connected?","indicator.connected")
    addObjectNotExists(adapter,"info","lastsync","Last successful sync","string","",null,"Last successful synchronization","value.datetime")
    addObjectNotExists(adapter,"info","lastsyncarchive","Last successful sync of archive data","string","",null,"Last successful synchronization of archive data","value.datetime")
    /*
    addObjectNotExists(adapter,"info","HWVersion","Hardware Version","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","SWVersion","Software Version","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","CO2Factor","CO2 Factor","number","",obj,"","meta")
    addObjectNotExists(adapter,"info","CO2Unit","CO2 Unit","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","CashFactor","Cash factor","number","",obj,"","meta")
    addObjectNotExists(adapter,"info","CashCurrency","Cash currency","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","DefaultLanguage","Default Language","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","DeliveryFactor","Delivery Factor","number","",obj,"","meta")
    addObjectNotExists(adapter,"info","PlatformID","Platform ID","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","ProductID","Product ID","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","TimezoneLocation","Timezone Location","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","TimezoneName","Timezone Name","string","",obj,"","meta")
    addObjectNotExists(adapter,"info","UTCOffset","UTC Offset [s]","number","",obj,"","meta")
    addObjectNotExists(adapter,"info","UniqueID","Unique ID","string","",obj,"","meta")
    */
    setTimeout(function() {
        adapter.log.debug("Fallback creating missing Info objects started")
        createStates(adapter,obj,"info");
        adapter.log.debug("Fallback creating missing Info objects finished!")
    }, 2000);
    

}
function createStates(adapter,data,prefix=""){
    for (var key in data){
        if(data[key.toString()] != null && typeof(data[key.toString()]) == "object"){ // this is a nested object to parse!
            if(data[key.toString()].hasOwnProperty('Value')){ // handling object with value and Unit below
                addObjectNotExists(adapter,prefix,key.toString(),'','','',data,'','');
...
function addObjectNotExists(adapter,path,stateId,stateName = '',stateType='', stateUnit='',apiObject=Object(null),stateDescription='',stateRole=''){
    ...
    if(apiObject === null || apiObject== 'undefined'){
        ...
        if(typeof(apiObject[stateId]) == 'object'){
        ...
        }else if(typeof(apiObject[stateId]) != 'object'){
            sObj.common.type = typeof(apiObject[stateId]);
        }
        adapter.setObjectNotExists(path + stateId, sObj);
    }else{
        adapter.log.warn("Object " + JSON.stringify(apiObject) + " does not have a property " + stateId + ", therefore no State was created");
    } 
}
